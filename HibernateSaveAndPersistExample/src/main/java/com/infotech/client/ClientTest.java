...
public class ClientTest {
	...
	public static void main(String[] args) {
		try (Session session = HibernateUtil.getSessionFactory().openSession()) {
			...
			/*
			 * persist() -> This method is used to save an entity/object into database and
			 * return a void. It will throw an exception if an entity already exists in the
			 * database.
			 */
			 ...
			 * return generated primarykey. It will throw an exception if an entity already
			 * exists in the database.
			 */
			Integer id = (Integer) session.save(getEmployee2());
			System.out.println("Employee is created  with Id::" + id);

			// saveOrUpdate()->This method is used to either save or update an entity in the
			// database.
